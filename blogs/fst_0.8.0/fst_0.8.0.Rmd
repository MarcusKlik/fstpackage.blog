...
The file size is about `r as.integer(100 * as.numeric(file.size("sampleset.fst") / object.size(df)))` percent of the original in-memory data frame size, the result of using a default compression setting of 50 percent. Apart from the resulting speed increase, smaller files are also attractive from a storage point of view.
